...
mongoose.prototype = {
    find:function(data,call,option,types){
        console.log('db find' , this.db.name);
        if(types){
    ...
    save:function(data,call){
        console.log('db save', this.db.name);
    ...
    findAll:function(data,call,types){
        console.log('db find all', this.db.name);
        var _this = this;
